export const drawRectAndLabelFace = (descriptions, faceDB, participants, ctx) => {
  ...
  descriptions &&
    descriptions.forEach((desc) => {
      ...
      const bestMatch = faceDB && faceDB?.findBestMatch(desc.descriptor);
      // Set styling
      if (bestMatch && bestMatch._label !== "unknown" && bestMatch._label !== null && bestMatch._label !== undefined) {
        ...
        bestMatch._label = filterParticipants[0].firstName + " " + filterParticipants[0].lastName + " (" + filterParticipants[0].studentId + ")";
      }
